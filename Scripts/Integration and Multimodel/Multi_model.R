...
seuratobjectMulti <- readRDS("./Output/Harmomy/Object/SeuratObjT_Harmony_Treat_Exp_ADT.rds")
...
saveRDS(seuratobjectMulti,"./Output/Harmomy/Object/Harmony_Integration_T_E_ADTV2_Final.rds")